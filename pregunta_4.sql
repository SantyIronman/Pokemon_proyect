--Promedio, valor maximo, valor minimo de los puntos base según el tipo de Pokémon que no sean defectuosos\
...
LEFT JOIN pokemon ON pokemon_stats.pokemon_id = pokemon.id
WHERE pokemon.is_default = "0"
